      ...
      <el-form ref="form" label-width="80px">
        <el-col :md="6" :sm="12" :xs="24">
          <el-form-item label="文章标题">
            <el-input v-full size="small"></el-input>
          </el-form-item>
        </el-col>
        <el-col :md="6" :sm="12" :xs="24">
        ...
        <el-form-item label="发表日期">
          <el-col :md="5" :sm="24" :xs="24">
            <el-date-picker size="small" type="date" v-full  placeholder="选择日期"></el-date-picker> 
          </el-col>
        ...
        <el-col :md="12" :sm="24" :xs="24">
          <el-form-item label="标签">
            <el-select  v-full v-model="value8" filterable size="small" placeholder="请选择文章标签">
